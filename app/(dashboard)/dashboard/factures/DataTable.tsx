...
import { Check, LucideIcon, PlusCircle, SlidersHorizontal } from "lucide-react";
import { Table } from "@tanstack/react-table";
import { X } from "lucide-react";
import { Input } from "@/components/ui/input";
import { statuses } from "@/db/data/data";
    ...
    <div>
      <Popover>
        ...
        <PopoverContent className="w-[200px] p-0" align="start">
          <Command>
            <CommandInput placeholder={etat} />
            <CommandList>
              <CommandEmpty>Non resultats </CommandEmpty>
              <CommandGroup>
                {options.map((option) => {
      ...
      <div className="flex items-center space-x-6 lg:space-x-8">
        ...
        <div className="flex items-center space-x-2">
          ...
          <Button
            ...
            disabled={!table.getCanNextPage()}
          >
            <span className="sr-only">Dernier page</span>
